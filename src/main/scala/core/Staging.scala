...
object Staging:
  ...
  private def quote(
    ...
    v match
      ...
      case VSplicePrim0(PTag, List(_, _, _, v))   => quote(vsplice0(v))
      case VSplicePrim0(PUntag, List(_, _, _, v)) => quote(vsplice0(v))
