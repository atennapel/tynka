...
object Syntax:
  ...
  enum Def:
    case DDef(name: Name, ty: Ty, stage: Stage, value: Tm)

    override def toString: String = this match
      case DDef(x, t, SMeta, v) => s"def $x : $t = $v"
      case DDef(x, t, STy, v)   => s"def $x : $t := $v"
  export Def.*
  ...
  enum Tm:
    ...
    case Let(name: Name, ty: Ty, stage: Stage, bty: Ty, value: Tm, body: Tm)
    case U(stage: Stage)
    ...
    override def toString: String = this match
      ...
      case Let(x, t, STy, _, v, b)   => s"(let $x : $t := $v; $b)"
      case U(SMeta)                  => "Meta"
      case U(STy)                    => s"Ty"
